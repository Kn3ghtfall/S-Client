                ...
                cheats: [
                    ...
                    },
                    {
                        ...
                        run: function () {
                            ...
                            stateNode.game.current.config.sceneConfig.physics.world.bodies.entries.forEach((x) => x?.gameObject?.receiveDamage?.(s.gameObject.hp, 1));
                        },
                    },
                    {
                        name: "Set Coins",
                ...
                cheats: [
                    {
                        ...
                        run: function () {
                            const colliders = getStateNode().game.current.config.sceneConfig.physics.world.colliders._active.filter((x) => s.callbackContext?.toString?.()?.includes?.("dmgCd"));
                    ...
                    },
                    {
                        ...
                        run: function () {
                            for (const collider of getStateNode().game.current.config.sceneConfig.physics.world.colliders._active.filter(
                                (x) => s.callbackContext?.toString().includes("invulnerableTime") || s.callbackContext?.toString().includes("dmgCd")
                            ))
                    ...
                    },
                    {
                        ...
                        run: function () {
                            getStateNode().game.current.config.sceneConfig.physics.world.bodies.entries.forEach((x) => x?.gameObject?.receiveDamage?.(s.gameObject.hp, 1));
                        },
                    },
                    {
                        name: "Magnet",
                        ...
                        run: function () {
                            getStateNode()
                                .game.current.config.sceneConfig.physics.world.colliders._active.find((x) => s.collideCallback?.toString().includes("magnetTime"))
                    ...
                    },
                    {
                        ...
                        run: function () {
                            let stateNode = getStateNode();
                            let { object1: player, object2: xp } = stateNode.game.current.config.sceneConfig.physics.world.colliders._active.find((x) => s.collideCallback?.toString().includes('emit("xp'));
                ...
                cheats: [
                    ...
                    },
                    {
                        ...
                        run: function () {
                            ...
                            ducks.forEach((x) => (tiles[s.y][s.x] = 0));
                            ducks.length = 0;
                        },
                    },
                    {
                                ...
                                this.data = setInterval(
                                    (stats) => {
                                        ...
                                        if (stateNode.state.phase == "choice") {
                                            Array.prototype.forEach.call(document.querySelectorAll(".choiceESP"), (x) => s.remove());
                                            ...
                                            Array.prototype.forEach.call(
                                                ...
                                                (x) => (s.onclick = () => Array.prototype.forEach.call(document.querySelectorAll(".choiceESP"), (x) => s.remove()))
                                            );
                                        }
                                    },
                                    50,
        ...
        for (const mode in cheats) {
            ...
            for (const cheat of cheats[mode].cheats) {
                ...
                runButton.onclick = () => {
                    cheat.run.apply(
                        cheat,
                        inputs.map((x) => (s.dataset[datasets.type] == "number" ? parseFloat("0" + s.value) : s.dataset[datasets.type] == "options" ? JSON.parse(s.value) : s.value))
                    );
                    if (cheat.type == "toggle") {
